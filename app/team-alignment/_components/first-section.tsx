    ...
    <div className="md:py-20">
      <div className="md:text-center space-y-4 px-10">
        <div className="md:text-3xl text-xl text-[#3d2e7c] font-medium">
          Neuromancer Labs Client Alignment
        </div>
        ...
        <p
          className="
            ...
            "
        >
          At Neuromancer Labs, we specialize in turning casual website visitors into devoted paying clients.
        </p>
          ...
          <div className="flex">
            ...
            >
              <div className="flex items-center justify-center gap-4 md:justify-between px-6">
                ...
                <div className="md:text-lg text-sm">Talk to us For Free</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-4xl md:text-7xl flex md:justify-center font-medium pt-20 md:pt-28 pb-10 md:pb-20">
            Why Companies Align with Neurmancer Labs
            ...
            <div className="flex flex-col space-y-6 pb-20">
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Customer Interaction and Feedback</div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Credibility and Trust Building</div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Showcasing Products and Services</div>
                </div>
