          ...
          <div className="md:flex md:px-20 px-5 md:space-x-20 md:space-y-0">
            ...
            >
              <div className="md:space-y-10 flex flex-col px-4 py-10"> 
                ...
                <div className="text-5xl md:text-7xl pb-4 md:pb-0">Android Apps</div>
                <div className="text-xl md:text-3xl w-5/6">
                  
                    Recipe of the Mobile Application, We Build
                      Best in Class Android Apps
                </div>
                <div className="md:flex pt-10 md:py-10">
                  <div className="space-y-10">
                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">Multilingual Feature</span>
                    </div>

                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">In-App Animation</span>
                    </div>

                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">Quick Loading</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-10 py-10 md:py-0 md:ml-40">
                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">Social Media Integration</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">Offline Mode Access</span>
                    </div>
                  </div>
                </div>
