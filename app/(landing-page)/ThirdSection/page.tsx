              ...
              md:text-3xl
               font-light
                ...
                flex
                 justify-center"
        >
          We offer services for the following niches:
        </div>
      </div>
                  ...
                  <div>
                    <div
                      className="
                                        ...
                                        "
                    >
                      Lightning fast resturant app development
                    </div>

                    <div className="text-lg text-[#3d2e7c] md:leading-10 font-light w-5/6 py-4">
                    Trusted Restaurant App Development Company Delivering Quality Results&apos;s 
                      app.
                    </div>
                    <Button
                      className="
