    ...
    <div className="md:py-20">
      <div className="md:text-center space-y-4 px-10">
        <div className="md:text-3xl text-xl text-[#3d2e7c] font-medium">
          Neuromancer Labs Will boost your sales
        </div>
        ...
        <p
          className="
            ...
            "
        >
          A well-designed and strategically optimized website can significantly boost sales for a business in several ways.
        </p>
          ...
          <div className="flex">
            ...
            >
              <div className="flex items-center justify-center gap-4 md:justify-between px-6">
                ...
                <div className="md:text-lg text-sm">Contact Us Here</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col space-y-6 pb-20">
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Understand your target audience</div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Use analytics to learn how customers find your store </div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                    <div className="bg-[#e8f5e3] w-12 h-12 items-center justify-center flex rounded-full">
                        ...
                        <div className="text-xl text-[#224229] font-light">Find your unique selling proposition</div>
                </div>
